...
public class ProductService{
    ...
    public Product saveProduct(Product product) {
    	  User user = userRepo.findById(product.getUserId())
                  .orElseThrow(() -> new ProductException("User not found with id: " + product.getUserId(),HttpStatus.NOT_FOUND));
    	  categoryRepo.findById(product.getCategoryId())
                  .orElseThrow(() -> new ProductException("Category not found with id: " + product.getCategoryId(),HttpStatus.NOT_FOUND));
